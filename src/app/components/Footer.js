            ...
            <section className={`px-[30px] pb-[30px] md:px-[60px] md:pb-[60px] w-full text-[22px] ${FontHankenGrotesk.variable}`}>
                <div className="flex flex:row justify-between">
                    <div className="max-w-[620px] w-full flex flex:row  justify-between">
                        ...
                        <a target="_blank" href="https://canal-street-dashboard.herokuapp.com/login">Vendor Login</a>

                    </div>
                    <a href="https://zero.nyc/">Site Originally by <span className="line-through">Zero</span></a>
                </div>
            </section>
        </footer>
    </>
